						   ...
						   UINT  writebuffersize)	// size to the writebuffer
{
	...
	int dwNum = MultiByteToWideChar(CP_ACP, 0, szPort, -1, NULL, 0);
	wchar_t *pwText;
	pwText = new wchar_t[dwNum];
	if(!pwText)
		delete[] pwText;
	MultiByteToWideChar (CP_ACP, 0, szPort, -1, pwText, dwNum);

	m_hComm = CreateFile(pwText,						// communication port string (COMX)
	...
	dwNum = MultiByteToWideChar(CP_ACP, 0, szBaud, -1, NULL, 0);
	pwText = new wchar_t[dwNum];
	if(!pwText)
		delete[] pwText;
	MultiByteToWideChar (CP_ACP, 0, szBaud, -1, pwText, dwNum);
...
void CSerialPort::ProcessErrorMessage(char* ErrorText)
{
	...
	int dwNum = MultiByteToWideChar(CP_ACP, 0, Temp, -1, NULL, 0);
	wchar_t *pwText;
	pwText = new wchar_t[dwNum];
	if(!pwText)
		delete[] pwText;
	...
	MessageBox(NULL, pwText, _T("Application Error"), MB_ICONSTOP);
...
void CSerialPort::WriteChar(CSerialPort* port,int length)
{
	...
	if (bWrite)
	{
		...
		CPublic::isSend[port->m_nPortNr - 1] = true;
